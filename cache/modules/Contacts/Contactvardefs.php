<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Pending Payment',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'pending_payment_c',
      'vname' => 'LBL_PENDING_PAYMENT',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Contactspending_payment_c',
      'custom_module' => 'Contacts',
    ),
    'default_interest_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Owner Commission(%)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'default_interest_c',
      'vname' => 'LBL_DEFAULT_INTEREST',
      'type' => 'int',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'min' => false,
      'max' => false,
      'id' => 'Contactsdefault_interest_c',
      'custom_module' => 'Contacts',
    ),
    'current_interest_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Group  Commission(%)',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'current_interest_c',
      'vname' => 'LBL_CURRENT_INTEREST',
      'type' => 'int',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'is calculated',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'is_calculated_c',
      'vname' => 'LBL_IS_CALCULATED',
      'type' => 'bool',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
